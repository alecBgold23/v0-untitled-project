        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <Accordion type="single" collapsible className="space-y-6">
            ...
            <AccordionItem value="item-4" className="border rounded-lg p-2 shadow-sm">
              ...
              <AccordionContent className="px-4 pb-4 text-gray-600">
                Yes, we cannot accept broken items, recalled products, or anything prohibited by resale platforms (like
                hazardous materials or heavily damaged goods).
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-9" className="border rounded-lg p-2 shadow-sm">
              ...
              <AccordionContent className="px-4 pb-4 text-gray-600">
                We're expanding! Currently, we operate in Chicago but plan to offer full nationwide service soon. Check
                our service area map on the website.
              </AccordionContent>
            </AccordionItem>
