...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          ...
          <ContentAnimation>
            ...
            >
              ...
              <p className="text-lg md:text-xl text-black mb-4 transition-all duration-300 group-hover:text-[#0066ff]">
      ...
      <section className="py-16 bg-gradient-to-b from-gray-100 to-gray-50 relative rounded-t-[30px] shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.1)] transform translate-y-[-1px] border-t border-gray-200 z-10 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 relative mb-12">
            ...
            <ContentAnimation delay={0.1}>
              <div className="flex flex-col items-center relative">
                <div className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center mb-4 z-10 border border-[#3B82F6]/20">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3B82F6] to-[#8c52ff] font-medium">
                    1
                  </span>
                </div>
                <h3 className="text-lg font-medium mb-2 text-center">Submit Your Item</h3>
            ...
            <ContentAnimation delay={0.2}>
              <div className="flex flex-col items-center relative">
                ...
                <h3 className="text-lg font-medium mb-2 text-center">We Pick It Up</h3>
                <p className="text-gray-500 text-center text-xs leading-relaxed max-w-xs">
            ...
            <ContentAnimation delay={0.3}>
              <div className="flex flex-col items-center relative">
                ...
                <h3 className="text-lg font-medium mb-2 text-center">Get Paid Instantly</h3>
                <p className="text-gray-500 text-center text-xs leading-relaxed max-w-xs">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <ContentAnimation delay={0.5}>
              <div className="p-4 rounded-lg bg-white hover:bg-gray-50 transition-all duration-300 group shadow-sm">
                ...
                <h3 className="text-base font-medium mb-1 text-gray-900">Simplified Process</h3>
            ...
            <ContentAnimation delay={0.6}>
              <div className="p-4 rounded-lg bg-white hover:bg-gray-50 transition-all duration-300 group shadow-sm">
                ...
                <h3 className="text-base font-medium mb-1 text-gray-900">Professional Service</h3>
                <p className="text-gray-500 text-xs leading-relaxed">
            ...
            <ContentAnimation delay={0.7}>
              <div className="p-4 rounded-lg bg-white hover:bg-gray-50 transition-all duration-300 group shadow-sm">
                ...
                <h3 className="text-base font-medium mb-1 text-gray-900">Market-Based Pricing</h3>
                <p className="text-gray-500 text-xs leading-relaxed">
            ...
            <ContentAnimation delay={0.8}>
              <div className="p-4 rounded-lg bg-white hover:bg-gray-50 transition-all duration-300 group shadow-sm">
                ...
                <h3 className="text-base font-medium mb-1 text-gray-900">Immediate Payment</h3>
                <p className="text-gray-500 text-xs leading-relaxed">
      ...
      <section className="py-16 bg-gradient-to-b from-gray-100 to-gray-50 relative rounded-t-[30px] shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.15)] border-t border-gray-200 z-20 mb-0">
        <div className="container mx-auto px-4 max-w-5xl">
          <ContentAnimation>
            <h2 className="text-2xl md:text-3xl font-light mb-8 text-center tracking-wide">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#3B82F6] to-[#8c52ff] font-medium">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            <ContentAnimation delay={0.1}>
              <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px]">
                ...
                <div>
                  <p className="font-medium text-xs">Sarah T.</p>
            ...
            <ContentAnimation delay={0.2}>
              <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px]">
                ...
                <div>
                  <p className="font-medium text-xs">Michael R.</p>
            ...
            <ContentAnimation delay={0.3}>
              <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px]">
                ...
                <div>
                  <p className="font-medium text-xs">Patricia L.</p>
        ...
        <div className="container mx-auto px-4 max-w-3xl pb-8">
          <ContentAnimation>
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px] border border-gray-100">
              ...
              <p className="text-gray-500 mb-4 max-w-xl mx-auto text-xs text-center">
              ...
              <div className="flex justify-center">
                <div className="inline-block bg-gradient-to-r from-[#3B82F6] to-[#8A4FFF] p-[2px] rounded-lg">
                  <Link
                    href="/sell-item"
                    className="inline-flex items-center bg-white hover:bg-gray-50 transition-colors px-4 py-2 rounded-lg font-medium text-gray-900 group text-sm"
                  >
                    Sell Your Item Now
