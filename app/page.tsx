        ...
        <div className="container mx-auto px-4">
          ...
          <ContentAnimation delay={0.1}>
            <div className="flex flex-row sm:flex-row items-center justify-center gap-2 md:gap-3">
              <Link
                href="/how-it-works"
                className="inline-block bg-gradient-to-r from-[#3B82F6] to-[#8c52ff] text-white px-12 py-1 md:px-8 md:py-1.5 rounded-full font-medium hover:shadow-md hover:translate-y-[-1px] transition-all text-center text-xs md:text-sm"
              >
              ...
              <Link
                ...
                className="inline-block border-2 border-[#6a5acd] text-[#6a5acd] px-12 py-1 md:px-8 md:py-1.5 rounded-full font-medium hover:bg-gradient-to-r hover:from-[#3B82F6] hover:to-[#8c52ff] hover:text-white hover:border-transparent hover:shadow-md hover:translate-y-[-1px] transition-all text-center text-xs md:text-sm"
              >
                Sell Your Item
              </Link>
            </div>
